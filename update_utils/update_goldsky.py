...
GOLDSKY_DIR = get_data_path('goldsky')
if not os.path.isdir(GOLDSKY_DIR):
    os.makedirs(GOLDSKY_DIR, exist_ok=True)

CURSOR_FILE = get_data_path('goldsky/cursor_state.json')
...
def get_latest_cursor():
    ...
    cache_file = get_data_path('goldsky/orderFilled.csv')
