...
def get_markets(main_file: str = None, missing_file: str = None):
    if main_file is None:
        main_file = get_data_path("markets.csv")
    if missing_file is None:
        missing_file = get_data_path("missing_markets.csv")
    """
...
def update_missing_tokens(missing_token_ids: List[str], csv_filename: str = None):
    if csv_filename is None:
        csv_filename = get_data_path("missing_markets.csv")
    """
